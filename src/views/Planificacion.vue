  ...
  <div>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Planificación</h1>
            <p class="text-white mt-0 mb-5">ISO 9001:2015 - Capítulo 6</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>ISO 9001:2015 - Capítulo 6
                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>Acciones para abordar riesgos y oportunidades
                </div>
                <hr class="my-4" />
                <p>El capítulo 6 establece los requisitos para que la organización planifique acciones para abordar riesgos y oportunidades, establezca objetivos de calidad y planifique los cambios.</p>
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <div class="accordion" id="accordionPlanificacion">
                ...
                <div class="card mb-3">
                  ...
                  <div id="collapse61" class="collapse show" aria-labelledby="heading61" data-parent="#accordionPlanificacion">
                    <div class="card-body">
                      <p>La organización debe determinar los riesgos y oportunidades que es necesario abordar para asegurar que el sistema de gestión de la calidad pueda lograr sus resultados previstos.</p>
                      ...
                      <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                          ...
                          <tbody>
                            <tr v-for="(doc, index) in getDocumentsBySection('6.1')" :key="index">
                              <td>{{ doc.nombre }}</td>
                            ...
                            <tr v-if="getDocumentsBySection('6.1').length === 0">
                ...
                <div class="card mb-3">
                  <div class="card-header" id="heading62">
                    <h5 class="mb-0">
                      <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse62" aria-expanded="false" aria-controls="collapse62">
                        6.2 Objetivos de la calidad y planificación para lograrlos
                      </button>
                    </h5>
                  </div>
                  <div id="collapse62" class="collapse" aria-labelledby="heading62" data-parent="#accordionPlanificacion">
                    <div class="card-body">
                      <p>La organización debe establecer objetivos de la calidad para las funciones y niveles pertinentes y los procesos necesarios para el sistema de gestión de la calidad.</p>
                      ...
                      <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                          ...
                          <tbody>
                            <tr v-for="(doc, index) in getDocumentsBySection('6.2')" :key="index">
                              <td>{{ doc.nombre }}</td>
                              <td>{{ formatDate(doc.fecha) }}</td>
                              <td>
                                <button class="btn btn-sm btn-info" @click="viewDocument(doc)">
                            ...
                            <tr v-if="getDocumentsBySection('6.2').length === 0">
                              <td colspan="3" class="text-center">No hay documentos disponibles.</td>
                            </tr>
                          </tbody>
                        </table>
                ...
                <div class="card mb-3">
                  ...
                  <div id="collapse63" class="collapse" aria-labelledby="heading63" data-parent="#accordionPlanificacion">
                    <div class="card-body">
                      <p>Cuando la organización determine la necesidad de cambios en el sistema de gestión de la calidad, estos cambios se deben llevar a cabo de manera planificada.</p>
                      ...
                      <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                          ...
                          <tbody>
                            <tr v-for="(doc, index) in getDocumentsBySection('6.3')" :key="index">
                              <td>{{ doc.nombre }}</td>
                              <td>{{ formatDate(doc.fecha) }}</td>
                              <td>
                                <button class="btn btn-sm btn-info" @click="viewDocument(doc)">
                            ...
                            <tr v-if="getDocumentsBySection('6.3').length === 0">
                              <td colspan="3" class="text-center">No hay documentos disponibles.</td>
                            </tr>
                          </tbody>
                        </table>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" v-model="newDocument.seccion">
                ...
                <option value="6.1">6.1 Acciones para abordar riesgos y oportunidades</option>
                <option value="6.2">6.2 Objetivos de la calidad y planificación para lograrlos</option>
                <option value="6.3">6.3 Planificación de los cambios</option>
              </select>
            </div>
            <div class="form-group">
    ...
    <div class="modal fade" :class="{'show d-block': showInfoModal}" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Planificación - ISO 9001:2015</h5>
            <button type="button" class="close" @click="showInfoModal = false">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <p>El capítulo 6 de la norma ISO 9001:2015 establece los requisitos para que la organización:</p>
            <ul>
              <li><strong>6.1:</strong> Determine los riesgos y oportunidades que es necesario abordar para asegurar que el sistema de gestión de la calidad pueda lograr sus resultados previstos.</li>
              <li><strong>6.2:</strong> Establezca objetivos de la calidad para las funciones y niveles pertinentes y los procesos necesarios para el sistema de gestión de la calidad.</li>
              <li><strong>6.3:</strong> Planifique los cambios en el sistema de gestión de la calidad de manera controlada.</li>
            </ul>
            <p>Este capítulo se centra en la planificación estratégica y operativa del sistema de gestión de calidad, con énfasis en el pensamiento basado en riesgos.</p>
          </div>
          <div class="modal-footer">
...
export default {
  ...
  methods: {
    ...
    uploadDocument() {
      ...
      const fileRef = storageRef.child(`planificacion/${Date.now()}_${this.selectedFile.name}`);
      ...
      fileRef.put(this.selectedFile).then(snapshot => {
        ...
        return firebase.database().ref('planificacion').push(docData);
      }).then(() => {
    ...
    loadDocuments() {
      firebase.database().ref('planificacion').once('value')
        .then(snapshot => {
          const docs = [];
